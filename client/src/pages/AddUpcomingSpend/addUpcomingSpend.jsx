...
function AddUpcomingSpendModal ({ isModalOpen, setIsModelOpen }){
    const categories = [
    "Groceries",
    "Entertainment",
    "Utilities",
    ...
    const handleSpentSubmit = async(e) => {
        ...
        const data = { title, category, amount, type, date };

        try {
            
            const response = await spendUtils.insertUpcomingSpend(data);
    ...
    <div className="modal-backdrop">
        ...
        <form className="add-spend-form" onSubmit={handleSpentSubmit}>
            ...
            />
            {date && <p className="date-output">Selected: {date}</p>}
...
export default AddUpcomingSpendModal;